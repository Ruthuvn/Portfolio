...
const projectsData = [
  {
    title: (
      <>
         Firmware <br />AR Glasses
      </>
    ),
    description: "Indoor Navigation System",
    link: "https://github.com/Ruthuvn/-phosphene.git",
  ...
  },
  {
    ...
    description: "Job interview platform",
    link: "https://github.com/Ruthuvn/AIMOCKINTERVIEW.git",
    imageLink: "/img/projects/2.avif",
  },
  {
    title: (
      <>
        Mental health <br /> web app
      </>
    ),
